import math
from osu_parser.curve import Bezier
...
def get_end_point(slider_type, slider_length, points):
    ...
    if slider_type == 'linear':
        ...
        if(radius==-1): # todo: investigate into the bug further
            return point_on_line(p1,p3,slider_length)
...
def get_circum_circle(p1, p2, p3):
    ...
    if(d==0):
        return -1,-1,-1 # todo: investigate this bug further
